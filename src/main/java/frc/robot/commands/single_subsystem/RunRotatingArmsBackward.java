...
public class RunRotatingArmsBackward extends CommandBase {
    /** Creates a new RunRotatingArmsForward. */
    private RotatingClimb rotatingArms;
    private double speed;

    public RunRotatingArmsBackward(RotatingClimb _rotatingArms, double _speed) {
    ...
    @Override
    public void execute() {
        rotatingArms.moveRotArmsBackward(speed);
    }
