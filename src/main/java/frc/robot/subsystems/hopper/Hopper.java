...
public class Hopper extends SubsystemBase {
    private VictorSPX lowerHopperMotor = new VictorSPX(Constants.HopperConstants.LOWER_HOPPER_MOTOR_ID);
    private VictorSPX upperHopperMotor = new VictorSPX(Constants.HopperConstants.UPPER_HOPPER_MOTOR_ID);
    DigitalInput upperHopperSensor = new DigitalInput(9);
    DigitalInput lowerHopperSensor = new DigitalInput(8);
    public boolean upperHopperStatus;
    public boolean lowerHopperStatus;
